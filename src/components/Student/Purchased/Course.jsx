...
import { FaChevronRight, FaPlay, FaStar, FaUsers } from "react-icons/fa";
  ...
  return (
    <div>
        ...
        >
                ...
                <p className="mb-2 flex items-center">
                  ...
                  {[...Array(5)].map((_, i) => (
                    <FaStar
                      key={i}
                      className={
                        i < Math.round(courseData?.Course?.Rate.toFixed(1) || 0)
                          ? "text-yellow-400"
                          : "text-gray-300"
                      }
                    />
          ...
          <div className="mt-8 mb-24 px-6 max-w-6xl mx-auto">
            ...
            courseData?.Course?.Course_Meets.length > 0 ? (
              courseData?.Course?.Course_Meets.map((meet, index) => (
                <MeetCard key={index} meet={meet} index={index} />
              ))
            ) : (
          ...
          {!courseData?.isReviewed && (
            <CourseReview courseId={courseId} setIsReviewed={setIsReviewed} />
          )}
        </div>
      ...
      <div className=" max-w-[80vw] pl-6 py-10">
        <h2 className="text-2xl font-bold text-gray-600 pl-6 mb-4">Reviews</h2>
