  ...
  return (
    <div className="hidden  md:flex  items-center justify-between mx-2 lg:mx-12  md:text-md lg:text-lg  font-[500] text-black_text h-full p-2 ">
      ...
      <div className="flex gap-6 lg:gap-14">
        <div
          className={` ${
            Active_nav == "Contact" ? "text-perpol_v" : "text-black_text"
        ...
        <div
          className={` ${
            Active_nav == "Courses" ? "text-perpol_v" : "text-black_text"
          } md:hover:text-perpol_v transition-all duration-150  cursor-pointer`}
        >
        ...
        <div
          className={` ${
            Active_nav == "Summaries" ? "text-perpol_v" : "text-black_text"
          } md:hover:text-perpol_v transition-all duration-150  cursor-pointer`}
        >
        ...
        <div
          className={` ${
            Active_nav == "Purchased" ? "text-perpol_v" : "text-black_text"
          } md:hover:text-perpol_v transition-all duration-150  cursor-pointer`}
        >
