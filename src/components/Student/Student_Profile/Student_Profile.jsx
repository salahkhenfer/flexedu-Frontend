...
function Student_Profile() {
    ...
    const ProfileItem = ({ label, value }) => (
        <div
            className="mb-4 bg-white bg-opacity-80 backdrop-blur-sm rounded-lg p-3 shadow-md
     transform md:hover:scale-105 transition-transform duration-300"
        >
    ...
    return (
     ...
     via-blue-500 to-indigo-600 md:p-8 py-6"
        >
