...
const Purchased = () => {
  ...
  const changeCcp = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        Swal.fire("Success", "CCP number changed successfully", "success");
    ...
    <div className="bg-gray-100 min-h-screen p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">CCP Information</h2>
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={() => {
                if (!ccpNumber) {
                  Swal.fire("Error", "CCP number is required", "error");
                  ...
                  Swal.fire("Error", "CCP number must be a number", "error");
                } else changeCcp();
              }}
