        ...
        <div>
          <Formik
            ...
            validate={(values) => {
              ...
              // }
              if (
                (values.telephone && values.telephone.length < 6) ||
              ...
              <Form className="flex flex-col text-sm md:text-lg gap-4 text-black_text">
                ...
                <div className="flex flex-col items-center gap-1">
                  {user?.profile_pic_link ? (
                    <>
                      <img
                        src={
                          "https://api.flexedu-dz.com/" + user?.profile_pic_link
                        }
                        alt="Profile Pic"
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-4 w-full pb-6">
                  <div className="w-full md:w-[50%] relative">
                    <div className="font-semibold text-sm pb-1">First Name</div>
                    <Field
                  ...
                  <div className="w-full md:w-[50%] relative">
                    <div className="font-semibold text-sm pb-1">Last Name</div>
                    <Field
                ...
                <div>
                  <div className="font-semibold text-sm pb-1">Email</div>
                  <Field
                    placeholder="Email"
                    type="text"
                    name="email"
