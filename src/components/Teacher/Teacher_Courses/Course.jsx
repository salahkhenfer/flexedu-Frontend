    ...
    const { value: formValues } = await Swal.fire({
      ...
      preConfirm: () => {
        ...
        // Ensure that the selected time is in the future
          ...
          Swal.showValidationMessage("Meeting link must be a valid URL.");
          return false;
        }
        return { link, time };
      },
      ...
      try {
        ...
        if (response.status === 201) {
          ...
          setCourse((prevCourse) => {
            return {
              ...prevCourse,
              Course_Meets: [...prevcourse?.Course_Meets, response.data],
            };
          });
    ...
    <div className="bg-gray-100 min-h-screen p-8">
      ...
      <div className="mt-8 max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-2xl font-semibold text-gray-800">Course Meets</h3>
          <button
