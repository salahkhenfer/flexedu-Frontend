  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-indigo-200 flex items-center justify-center p-6">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-2xl">
        <h1 className="text-3xl font-bold text-indigo-700 mb-6">Add Summary</h1>
        ...
        <Formik
          ...
          validate={(values) => {
            ...
            else if (values.Price < 0) errors.Price = "Price must be positive";
              ...
              >
                {summaryFile ? (
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-lg font-semibold">{summaryFile.name}</p>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-lg">Drag & Drop your PDF here</p>
                    <p className="text-sm text-gray-500">
